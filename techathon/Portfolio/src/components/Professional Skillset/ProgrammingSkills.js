...
import { CSharp, Python, DotNet, MySql, ReactJS, NodeJs, JavaScript, Redux } from "../asset/svg/svg";
import { useSelector } from "react-redux";
const skills = [CSharp, Python, MySql, ReactJS, JavaScript, NodeJs, DotNet, Redux];
const skillNames=["C#","Python","MySql","ReactJs","JavaScript","NodeJs","DotNet","Redux"];
